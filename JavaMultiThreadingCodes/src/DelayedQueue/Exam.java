...
public class Exam {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < studentNumber; i++) {
            queue.put(new Student("student" + (i + 1), 30 + random.nextInt(120), countDownLatch));
        }

        Thread teacherThread = new Thread(new Teacher(queue));
        queue.put(new EndExam(queue, 120, countDownLatch, teacherThread));
        teacherThread.start();
